...
class QueenChessBoard:
    '''Code from: https://www.sanfoundry.com/python-program-solve-n-queen-problem-without-recursion/ '''
...
if __name__ == "__main__" :
    ...
    while True:
        ...
        if end - ini > 60:
            print('We can solve a board of maximum size {} under 1 minute.'.format(size - 1))
            print('With size {0}, it took {1} s.'.format(size, end - ini))
            break
        size += 1
