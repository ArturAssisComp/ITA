...
class Sistema:
    ...
    def return_bank_statement(self):
        return self.client_data["bank_statement"]
    ...
    def return_balance(self):
        return self.client_data["balance"]
...
class Application(tk.Frame):
    ...
    def return_bank_statement_button(self):
        ...
        self.invoker.set_command(new_command)
        bank_statement = self.invoker.execute_command()
    ...
    def return_balance_button(self):
        ...
        self.invoker.set_command(new_command)
        print("Total : R${0:.2f}".format(self.invoker.execute_command()))
